const lang = {
  es: {
    ...
    plans: [
      ...
      },
      {
        ...
        bundle: {
          ...
          originalPrice: "USD 237 pagando mes a mes",
          discountLabel: "Ahorra USD 37",
    ...
    processTitle: "No compras un plan. Te sumas a un proceso.",
    process: [
      [
        "PILAR I",
        "CUERPO",
    ...
    interests: {
      ...
      undecided: "Aún no lo sé — quiero orientación",
    },
    submit: "Preparar mi mensaje para Roo",
    formHint:
      "Se abrirá WhatsApp con tu mensaje listo. Tú decides si lo envías.",
    formStatus: "WhatsApp se abrió con tu mensaje listo para revisar.",
    formFallbackStatus:
      "No pude abrir WhatsApp automáticamente. Usa este enlace para continuar.",
    formFallbackAction: "Abrir WhatsApp manualmente",
    directContact: "O escríbeme directamente",
    whatsapp: "WhatsApp",
    email: "Email",
    instagram: "Instagram",
    language: "EN",
  ...
  en: {
    ...
    plans: [
      ...
      },
      {
        ...
        bundle: {
          ...
          originalPrice: "USD 237 paying month by month",
          discountLabel: "Save USD 37",
    ...
    processTitle: "You are not buying a plan. You are joining a process.",
    process: [
      [
        "PILLAR I",
        "BODY",
    ...
    interests: {
      ...
      undecided: "I am not sure yet — I want guidance",
    },
    submit: "Prepare my message for Roo",
    formHint:
      "WhatsApp will open with your message ready. You decide if you send it.",
    formStatus: "WhatsApp opened with your message ready to review.",
    formFallbackStatus:
      "I could not open WhatsApp automatically. Use this link to continue.",
    formFallbackAction: "Open WhatsApp manually",
